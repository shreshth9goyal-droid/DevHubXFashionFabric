...
const spaImages = [
  { src: "/images/collection-pateners/collection-right-side-images/Spa- Saloon/Untitled-5-01.webp", alt: "Spa professionals in purple uniform" },
  { src: "/images/collection-pateners/collection-right-side-images/Spa- Saloon/Untitled-5-02.webp", alt: "Spa staff in black uniform with orange trim" },
  { src: "/images/collection-pateners/collection-right-side-images/Spa- Saloon/Untitled-5-03.webp", alt: "Salon team member 3" },
  { src: "/images/collection-pateners/collection-right-side-images/Spa- Saloon/Untitled-5-04.webp", alt: "Salon team member 4" },
  { src: "/images/collection-pateners/collection-right-side-images/Spa- Saloon/Untitled-5-05.webp", alt: "Salon team member 5" },
]
 ...
 <div className="flex justify-center px-2 sm:px-4 md:px-8 lg:px-12 mb-10 sm:mb-12 md:mb-16 pt-4 sm:pt-6 md:pt-10">
  <div className="relative w-full max-w-7xl min-h-[520px] sm:min-h-[550px] md:min-h-[600px] md:h-[600px] bg-[#1a3c1a] rounded-lg overflow-hidden shadow-2xl flex items-center">
        ...
        <div className="relative z-10 w-full h-full flex flex-col md:flex-row items-start md:items-center justify-between px-3 sm:px-4 md:px-16 pt-4 sm:pt-6 md:pt-0 gap-3 sm:gap-4 md:gap-12">
          ...
          {/* Image on Right Side */}
          <div className="w-full md:w-3/5 h-[650px] sm:h-[600px] md:h-full flex items-end justify-center md:justify-end">
