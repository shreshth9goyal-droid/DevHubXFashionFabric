...
const healthcareImages = [
  { src: "/images/collection-pateners/collection-right-side-images/Healthcare/Untitled-2-01.webp", alt: "Healthcare staff uniform 1" },
  { src: "/images/collection-pateners/collection-right-side-images/Healthcare/Untitled-2-02.webp", alt: "Healthcare staff uniform 2" },
  { src: "/images/collection-pateners/collection-right-side-images/Healthcare/Untitled-2-03.webp", alt: "Healthcare staff uniform 3" },
  { src: "/images/collection-pateners/collection-right-side-images/Healthcare/Untitled-2-04.webp", alt: "Healthcare staff uniform 4" },
  { src: "/images/collection-pateners/collection-right-side-images/Healthcare/Untitled-2-05.webp", alt: "Healthcare staff uniform 5" },
]
export default function HealthcareUniformPage() {
  return (
          ...
          <div className="w-full md:w-3/5 h-[500px] sm:h-[450px] md:h-full flex items-end justify-center md:justify-end">
            <div className="relative w-full h-full flex items-end justify-center md:justify-end">
              <Image
                ...
                alt="Healthcare professionals in professional medical wear"
                fill
              ...
              <div className="flex flex-col items-center justify-center">
                ...
                <div className="w-full max-w-4xl p-5 sm:p-8 md:p-12 lg:p-16 text-center">
                  ...
                  <p className="text-sm sm:text-base md:text-lg lg:text-xl text-black mb-4 sm:mb-6 md:mb-8 leading-relaxed">
                    ...
                    show you our customization options, and create a solution that perfectly fits your healthcare facility's brand.
                  </p>
          ...
          <AnimateIn>
            ...
            <div className="max-w-7xl pl-2 sm:pl-4 md:pl-10 pr-2 sm:pr-4 md:pr-6 space-y-2 md:space-y-3">
              <FAQItem
                ...
                answer="Yes, our fabrics are selected for high wash durability, colourfastness, and shape retention, maintaining a professional appearance through repeated hospital laundry cycles."
              />
              <FAQItem
              ...
              />
              <FAQItem
                question="Can uniforms be colour-coded according to hospital departments?"
